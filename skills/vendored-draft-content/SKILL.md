---
name: vendored-draft-content
description: Draft blog posts, social media, email newsletters, landing pages, press releases, and case studies with channel-specific formatting and SEO recommendations. Use when writing any marketing content, when you need headline or subject line options, or when adapting a message for a specific platform, audience, and brand voice. Vendored copy of the upstream `marketing:draft-content` skill — comp-voice's compose-mp pipeline borrows its content-type patterns when drafting the 微信公众号 article (note: 公众号 is NOT a native content type here, see compose-mp/references/wechat-mp-style.md for the 公众号-specific structure). If the upstream `/marketing:draft-content` is also installed, prefer that one.
argument-hint: "<content type and topic>"
---

<!-- VENDORED COPY — body verbatim from upstream.
     Source: knowledge-work-plugins/marketing 1.2.0, skills/draft-content/SKILL.md
     License: see ./LICENSE in this directory
     Vendored into comp-voice on 2026-05-15 so the plugin works without the upstream installed. -->
